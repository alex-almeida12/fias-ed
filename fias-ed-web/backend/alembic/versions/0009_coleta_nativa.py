...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_consentimento_qti_coleta_id'), 'consentimento_qti', ['coleta_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_consentimento_qti_coleta_id'), table_name='consentimento_qti')
